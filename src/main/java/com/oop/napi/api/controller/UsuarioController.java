...
@Api(value = "Endpoint para usuários")
public class UsuarioController {
    ...
    @GetMapping("/listar")
    @ApiOperation(value = "Lista todos os usuarios", response = Usuario[].class)
    ...
    @ApiOperation(value = "Adiciona um usuarios", response = Usuario.class)
    ...
    @ApiOperation(value = "Recupera a senha do usuário")
